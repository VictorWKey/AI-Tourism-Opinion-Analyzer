...
type SetupStep = 'welcome' | 'preferences' | 'python-setup' | 'hardware-select' | 'llm-choice' | 'model-select' | 'llm-setup' | 'models' | 'output-dir' | 'complete';
...
const STEP_ORDER: SetupStep[] = ['welcome', 'preferences', 'python-setup', 'hardware-select', 'llm-choice', 'model-select', 'llm-setup', 'models', 'output-dir', 'complete'];
...
// Preferences Step - Theme and Language Selection
