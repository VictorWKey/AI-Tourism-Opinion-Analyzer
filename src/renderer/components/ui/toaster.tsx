 ...
 * Toaster Component
 * ==================
 * Toast notification container using Radix UI
 */
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ...
    className={cn(
      ...
      'group-[.destructive]:border-slate-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-slate-50 group-[.destructive]:focus:ring-red-500',
      className
    )}
    {...props}
  />
