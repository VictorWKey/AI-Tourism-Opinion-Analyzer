 ...
 *   3. Fecha de la opinión (required)
 *   4. Calificación / Polaridad (required)
 */
...
const MAPPING_FIELDS: MappingField[] = [
  ...
  },
  {
    ...
    description:
      'La fecha en que se realizó la estadía, visita o se escribió la opinión.',
    required: true,
    icon: Calendar,
  },
  {
    ...
    description:
      'La puntuación numérica o calificación dada (ej: 1-5 estrellas, 1-10, etc.).',
    required: true,
    icon: Star,
  },
];
