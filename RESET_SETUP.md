...
Remove-Item "$env:APPDATA\ai-tourism-analyzer-desktop\setup-state.json" -Force -ErrorAction SilentlyContinue
Remove-Item "$env:APPDATA\ai-tourism-analyzer-desktop\ai-tourism-analyzer-config.json" -Force -ErrorAction SilentlyContinue

# 6. Eliminar estado de pipeline/fases y datos (Zustand persisted en Local Storage y Session Storage)
Remove-Item -Path "$env:APPDATA\ai-tourism-analyzer-desktop\Local Storage" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item -Path "$env:APPDATA\ai-tourism-analyzer-desktop\Session Storage" -Recurse -Force -ErrorAction SilentlyContinue
...
Remove-Item -Path "$env:APPDATA\ai-tourism-analyzer-desktop" -Recurse -Force -ErrorAction SilentlyContinue
