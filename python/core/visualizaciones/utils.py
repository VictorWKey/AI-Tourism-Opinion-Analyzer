...
COLORES_SENTIMIENTO = {'Positivo': COLORES['positivo'], 'Neutro': COLORES['neutro'], 'Negativo': COLORES['negativo']}
...
ESTILOS = {
    'titulo': {'fontsize': FONT_SIZES['titulo'], 'fontweight': 'bold', 'color': COLORES['texto']},
    'subtitulo': {'fontsize': FONT_SIZES['subtitulo'], 'fontweight': 'normal', 'color': COLORES['texto']},
    'etiquetas': {'fontsize': FONT_SIZES['etiquetas'], 'color': COLORES['texto']},
    'figura': {'facecolor': COLORES['fondo'], 'dpi': 300},
}
