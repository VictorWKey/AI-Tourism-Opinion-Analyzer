...
class GeneradorTexto:
    ...
    def _generar_distribucion_longitud(self):
        ...
        ax1.axvline(
            ...
            linestyle='--',
            linewidth=2,
            label=t('media_valor', value=f'{longitudes.mean():.1f}'),
        )
        ax1.axvline(
            longitudes.median(),
            ...
            linestyle='--',
            linewidth=2,
            label=t('mediana_valor', value=f'{longitudes.median():.1f}'),
        )
    ...
    def _generar_top_bigramas(self):
        ...
        bars = ax.barh(
            range(len(bigramas)), valores, color=colores, edgecolor=COLORES['borde_separador'], linewidth=0.5
        )
    ...
    def _generar_top_trigramas(self):
        ...
        bars = ax.barh(
            range(len(trigramas)), valores, color=colores, edgecolor=COLORES['borde_separador'], linewidth=0.5
        )
