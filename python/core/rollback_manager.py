...
class RollbackManager:
    ...
    def __init__(self):
        ...
        self._session_phase: int | None = None
    ...
    def rollback(self, session_id: str | None = None) -> dict[str, any]:
        """
        ...
        with self._lock:
            ...
            results = {'success': True, 'restored_files': [], 'deleted_files': [], 'errors': []}
            ...
            try:
                ...
                for relative_path, _original_hash in manifest.get('backed_up_files', {}).items():
    ...
    def get_active_phase(self) -> int | None:
        """Get the current active phase number."""
        return self._session_phase

    def find_pending_session(self) -> str | None:
        """
