...
def test_importaciones():
    ...
    try:
        from core.fase_08_visualizaciones import GeneradorVisualizaciones  # noqa: F401

        print('   ✓ GeneradorVisualizaciones importado')

        from core.visualizaciones.validador import ValidadorVisualizaciones  # noqa: F401

        print('   ✓ ValidadorVisualizaciones importado')

        from core.visualizaciones.utils import COLORES, CONFIG_EXPORT  # noqa: F401

        print('   ✓ Utilidades importadas')

        from core.visualizaciones.generador_dashboard import GeneradorDashboard  # noqa: F401

        print('   ✓ GeneradorDashboard importado')

        from core.visualizaciones.generador_sentimientos import GeneradorSentimientos  # noqa: F401

        print('   ✓ GeneradorSentimientos importado')

        from core.visualizaciones.generador_categorias import GeneradorCategorias  # noqa: F401

        print('   ✓ GeneradorCategorias importado')

        from core.visualizaciones.generador_topicos import GeneradorTopicos  # noqa: F401

        print('   ✓ GeneradorTopicos importado')

        from core.visualizaciones.generador_temporal import GeneradorTemporal  # noqa: F401
...
def test_generador():
    ...
    try:
        ...
        _generador = GeneradorVisualizaciones(dataset_path=str(dataset_path), output_dir='data/visualizaciones_test')
...
def main():
    ...
    tests = [test_importaciones, test_validador, test_generador]
